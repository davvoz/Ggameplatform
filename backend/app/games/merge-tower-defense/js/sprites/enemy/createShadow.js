import { MultiPartSprite,  AnimationClip } from
...
export function shadow() {
    ...
    trail.setBaseTransform(-0.08, 0.1);
    ...
    idle.addTrack('hood', [
        ...
        { time: 2.5, transform: { scaleX: 1, scaleY: 1 } }
    ]);
    idle.addTrack('wispLeft', [
        { time: 0, transform: { rotation: 0, x: 0, scaleY: 1 } },
        { time: 0.5, transform: { rotation: -0.2, x: -0.04, scaleY: 1.08 } },
        { time: 1, transform: { rotation: 0.1, x: 0.02, scaleY: 0.95 } },
        { time: 1.5, transform: { rotation: -0.25, x: -0.05, scaleY: 1.12 } },
        { time: 2, transform: { rotation: 0.08, x: 0.01, scaleY: 1 } },
        { time: 2.5, transform: { rotation: 0, x: 0, scaleY: 1 } }
    ]);
    ...
    idle.addTrack('trail', [
        { time: 0, transform: { scaleX: 1, scaleY: 1, x: 0 } },
        { time: 0.8, transform: { scaleX: 1.15, scaleY: 1.08, x: -0.02 } },
        { time: 1.6, transform: { scaleX: 1.2, scaleY: 1.12, x: 0.02 } },
        { time: 2.5, transform: { scaleX: 1, scaleY: 1, x: 0 } }
    ]);
    ...
    walk.addTrack('body', [
        ...
        { time: 0.35, transform: { y: -0.02, rotation: -0.04, scaleY: 1 } },
    ...
    walk.addTrack('wispLeft', [
        { time: 0, transform: { rotation: 0.18, x: 0.02, scaleY: 1 } },
        ...
        { time: 0.7, transform: { rotation: 0.18, x: 0.02, scaleY: 1 } }
    ]);
    ...
    walk.addTrack('trail', [
        { time: 0, transform: { scaleX: 1, x: -0.03 } },
        { time: 0.35, transform: { scaleX: 1.2, x: -0.06 } },
        { time: 0.7, transform: { scaleX: 1, x: -0.03 } }
    ]);
    ...
    attack.addTrack('body', [
        { time: 0, transform: { rotation: 0, scaleX: 1, y: 0 } },
        { time: 0.15, transform: { rotation: -0.15, scaleX: 0.92, y: -0.04 } },
        { time: 0.35, transform: { rotation: 0.2, scaleX: 1.15, y: 0.03 } },
        { time: 0.55, transform: { rotation: 0, scaleX: 1, y: 0 } }
    ]);
    ...
    attack.addTrack('hood', [
        ...
        { time: 0.55, transform: { scaleX: 1, scaleY: 1 } }
    ]);
    attack.addTrack('wispLeft', [
        { time: 0, transform: { rotation: 0, x: 0, scaleY: 1 } },
        { time: 0.15, transform: { rotation: 0.35, x: 0.05, scaleY: 0.9 } },
        { time: 0.35, transform: { rotation: -0.5, x: -0.08, scaleY: 1.3 } },
        { time: 0.55, transform: { rotation: 0, x: 0, scaleY: 1 } }
    ]);
    ...
    phase.addTrack('body', [
        { time: 0, transform: { scaleX: 1, scaleY: 1, y: 0 } },
        ...
        { time: 0.6, transform: { scaleX: 1, scaleY: 1, y: 0 } }
    ]);
    phase.addTrack('head', [
        { time: 0, transform: { scaleX: 1, scaleY: 1 } },
    ...
    phase.addTrack('wispLeft', [
        { time: 0, transform: { scaleX: 1, rotation: 0 } },
        { time: 0.3, transform: { scaleX: 0.3, rotation: -0.5 } },
        { time: 0.6, transform: { scaleX: 1, rotation: 0 } }
    ]);
    ...
    hit.addTrack('body', [
        ...
        { time: 0.3, transform: { x: 0, scaleX: 1 } }
    ]);
    hit.addTrack('head', [
        { time: 0, transform: { rotation: 0 } },
        { time: 0.08, transform: { rotation: -0.2 } },
    ...
    hit.addTrack('hood', [
        ...
        { time: 0.3, transform: { scaleX: 1 } }
    ]);
    hit.addTrack('wispLeft', [
        { time: 0, transform: { rotation: 0, x: 0 } },
        { time: 0.1, transform: { rotation: 0.3, x: 0.04 } },
    ...
    const death = new AnimationClip('death', 1, false);
    death.addTrack('body', [
        { time: 0, transform: { y: 0, scaleY: 1, scaleX: 1, rotation: 0 } },
