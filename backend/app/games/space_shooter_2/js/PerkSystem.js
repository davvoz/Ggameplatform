...
const PERK_CATALOG = [
    ...
    },
    {
        ...
        description: '20% of damage taken → ultimate charge.',
        stackDesc: '+10% conversion per stack',
        category: 'defensive',
        rarity: 'rare',
        maxStacks: 2,
        icon: '⟳'
    ...
    },
    {
        ...
        description: 'Ultimate ability charges 35% faster.',
        stackDesc: '+20% charge speed per stack',
        category: 'utility',
        rarity: 'rare',
        maxStacks: 2,
        icon: '★'
    ...
    },
    {
        id: 'orbital_drone',
        name: 'Orbital Drone',
        description: 'A drone orbits your ship, auto-shooting enemies.',
