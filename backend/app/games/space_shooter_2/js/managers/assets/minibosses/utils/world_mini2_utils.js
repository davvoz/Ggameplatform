...
export function generateVineSprite(dark, accent, sprites) {
...
export function generateCore5(color, dark, accent, sprites) {
...
export function drawMiniBossCore(color, sprites) {
...
export function createMiniBossShield(sprites) {
...
export function generateMiniBossBase(color, sprites) {
...
export function renderTurretSprite(accent, sprites) {
...
export function drawMiniBossClaw(dark, accent, color, sprites) {
...
export function drawMiniBossStructure(color, dark, sprites) {
