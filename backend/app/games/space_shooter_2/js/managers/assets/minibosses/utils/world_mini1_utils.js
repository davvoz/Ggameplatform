...
export function generateBladeSprite(accent, sprites) {
...
export function generateMiniBossCore(color, dark, sprites) {
...
export function generateMiniBossTurret(accent, sprites) {
...
export function createMiniBossShieldSprite(sprites) {
...
export function createMiniBossCoreSprite(color, dark, sprites) {
...
export function renderMiniBossStreaks(dark, accent, sprites) {
...
export function renderOrbWithGlow(accent, sprites) {
...
export function drawMiniBossDiamond(color, sprites) {
...
export function generatePodSprite(dark, sprites) {
...
export function generateCoreSprite(color, accent, sprites) {
