...
Migration script to add the push_subscriptions table to an existing database.
...
def create_push_subscriptions_table():
    ...
    # Create only the PushSubscription table
...
if __name__ == "__main__":
    print("=" * 50)
    print("Push Subscriptions Table Migration")
    print("=" * 50)
