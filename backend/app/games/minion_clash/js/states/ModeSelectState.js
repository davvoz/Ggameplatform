...
/**
 * Mode selection screen. Multiplayer is intentionally locked.
 */
export class ModeSelectState {
    ...
    enter() {
        ...
        this._buttons = [
            { id: 'campaign',    label: 'CAMPAIGN',    subLabel: 'Single player — 5 levels',
              x: cx - 130, y: 380, w: 260, h: 70, enabled: true },
            { id: 'multiplayer', label: 'MULTIPLAYER', subLabel: '1v1 real-time',
    ...
    render(ctx) {
        ...
        UIPainter.text(ctx, 'Tactical Card RTS', GameConfig.VIEW_WIDTH / 2, 220,
            { font: '16px system-ui', color: GameConfig.COLOR.TEXT_DIM, align: 'center' });
