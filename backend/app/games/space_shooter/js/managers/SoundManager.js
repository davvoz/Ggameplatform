...
class SoundManager {
    ...
    init() {
        ...
        try {
            ...
            console.warn('Web Audio API non supportato o inizializzazione fallita:', e);
            this.enabled = false;
        }
    }
    ...
    async unlockIOSAudio() {
        ...
        try {
            ...
            console.warn('Errore durante lo sblocco dell\'audio iOS:', e);
        }
    }
    ...
    async loadBackgroundMusic(url) {
        ...
        try {
            ...
            console.warn('Errore durante il caricamento della musica di background:', e);
        }
    }
    ...
    decodeAudioDataSafe(arrayBuffer) {
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                console.warn('decodeAudioData promise-based non supportato, usando fallback callback-based:', e);
    ...
    async playBackgroundMusic() {
        ...
        try {
            ...
            console.warn('Errore durante la riproduzione della musica di background:', e);
    ...
    stopBackgroundMusic() {
        if (this.bgMusicSource) {
            try {
                ...
                console.warn('Errore durante l\'interruzione della musica di background:', e);
            }
    ...
    ensureAudioReady() {
        ...
        if (this.audioContext?.state === 'suspended') {
            this.audioContext.resume().catch(e => {
                console.warn('Errore durante il resume dell\'AudioContext:', e);
            });
        }
        return true;
    }
