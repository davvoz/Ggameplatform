...
export class DissolvingEffectRenderer extends PlatformEffectRenderer {
    ...
    renderFallingParticles(platform, x, y, dissolveProgress) {
        for (let i = 0; i < DissolvingEffectRenderer.PARTICLE_COUNT; i++) {
            ...
            this.renderer.drawCircle(particleX, particleY, particleSize, [1, 0.8, 0.3, alpha]);
        }
    }
    ...
    renderIdleState(platform, x, y, time) {
        ...
        this.renderer.drawRect(x, y, platform.width, 2, [1, 0.8, 0.2, pulse]);
        this.renderer.drawRect(x, y + platform.height - 2, platform.width, 2, [1, 0.8, 0.2, pulse]);
    ...
    renderSparkle(platform, x, y, time) {
        ...
        if (sparklePhase < 0.3) {
            ...
            this.renderer.drawCircle(sparkleX, sparkleY, 2, [1, 1, 0.8, sparklePhase * 3]);
        }
    }
}
